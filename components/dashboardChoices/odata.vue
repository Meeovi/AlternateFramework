      ...
      >
        ...
        <v-card class="mx-auto" max-width="200" v-bind="props">
            <v-img class="align-end text-white" height="200" width="200"
                ...
                <v-card-title style="width:100%;text-align:center;">Odata / Microsoft Graph</v-card-title>
            </v-img>
        </v-card>
    </template>
      <v-card>
        <v-card-text>
          <v-container>
            <v-row>
              ...
              <v-col cols="12">
                <v-text-field label="Endpoint*" id="neoEndpoint" hint="https://services.odata.org/TripPinRESTierService/" required></v-text-field>
              </v-col>
            </v-row>
          </v-container>
