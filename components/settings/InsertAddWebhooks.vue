                ...
                <v-card-text>
                    <v-container>
                        <v-row>
                            ...
                            <v-col cols="12">
                                <div class="text-subtitle-1 text-medium-emphasis">Headers</div>
                            </v-col>
                            <v-col cols="6">
                                <v-autocomplete :items="['7 Days', '30 Days', '90 Days', '180 Days', 'Unlimited']" label="Token Duration*" required></v-autocomplete>
                            </v-col>
                            <v-col cols="6">
